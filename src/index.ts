...
import { RnacentralDataDO } from "./do";

export { RnacentralDataDO };

interface RnacentralEnv {
...
export default {
    fetch(request: Request, env: Env, ctx: ExecutionContext) {
        ...
        if (url.pathname === "/health") {
            return buildHealthResponse("rnacentral");
        }
        ...
        if (url.pathname === "/readyz") {
            ...
            return MyMCP.readiness(env, "rnacentral");
        }
